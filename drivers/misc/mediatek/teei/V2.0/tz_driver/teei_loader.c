				...
				unsigned long arg)
{
	...
	switch (cmd) {
		case TEEI_LOAD_TA:
			//IMSG_PRINTK("CMDID: TEEI_LOAD_TA is coming!1\n");
			//IMSG_PRINTK("CMDID: TEEI_LOAD_TA is coming!2\n");
			//IMSG_PRINTK("CMDID: TEEI_LOAD_TA is coming!3\n");
			retVal = load_ta_fn(arg);	
			//IMSG_PRINTK("CMDID: TEEI_LOAD_TA is coming!4\n");			
			//IMSG_PRINTK("CMDID: TEEI_LOAD_TA is coming!5\n");			
			break;
