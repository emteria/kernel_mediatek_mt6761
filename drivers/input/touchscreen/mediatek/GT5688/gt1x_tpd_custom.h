...
#define MODULE_SENSOR_ID0					0
#define MODULE_SENSOR_ID1					1
#define MODULE_SENSOR_ID2					2
#define MODULE_SENSOR_ID3					3
#define MODULE_SENSOR_ID4					4
#define MODULE_SENSOR_ID5					5
